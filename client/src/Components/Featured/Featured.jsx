...
function Featured() {
  ...
  return (
    <div className="py-16 px-8 dark:bg-gray-900 flex flex-col lg:flex-row items-center justify-start h-full">
      ...
      <div className="lg:flex-1 flex flex-col justify-center lg:pl-8 mt-8 lg:mt-0 dark:text-white">
