...
function Comment() {
  ...
  return (
    <div className={isDark && `dark`}>
      <div className="p-12  dark:bg-black  flex flex-col md:flex-row items-center justify-between">
        ...
        <div className="mt-6 md:mt-0 md:ml-8 lg:ml-14 flex flex-col w-full md:w-[50%]">
          ...
          <p className="text-left text-xs  dark:text-white md:text-lg lg:text-xl mb-6  md:text-left">
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between">
            <div className="mb-4 md:mb-0  dark:text-white text-left">
              ...
              <span className="t dark:text-white text-sm">Student</span>
            </div>
            <a href="#testimonial">
              <span className="t dark:text-white flex items-center gap-3 font-bold cursor-pointer text-sm md:text-base">
                See All reviews
